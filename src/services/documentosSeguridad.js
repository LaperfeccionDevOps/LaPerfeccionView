...
export async function EliminarDocumentoSeguridadPorTipo(idRegistroPersonal, idTipoDocumentacion) {
  const token = getToken();
  const url = getApiUrl(`/documentos-seguridad/registro/${idRegistroPersonal}/tipo/${idTipoDocumentacion}`);
